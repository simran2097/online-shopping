...
import net.sim.onlineshopping.util.FileUtil;
import net.sim.onlineshopping.validator.ProductValidator;
import net.sim.shoppingbackend.dao.CategoryDAO;
import net.sim.shoppingbackend.dao.ProductDAO;
import net.sim.shoppingbackend.dto.Category;
