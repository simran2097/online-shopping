package net.sim.onlineshopping.handler;
...
import net.sim.onlineshopping.model.CheckoutModel;
import net.sim.onlineshopping.model.UserModel;
import net.sim.shoppingbackend.dao.CartLineDAO;
import net.sim.shoppingbackend.dao.ProductDAO;
import net.sim.shoppingbackend.dao.UserDAO;
import net.sim.shoppingbackend.dto.Address;
import net.sim.shoppingbackend.dto.Cart;
import net.sim.shoppingbackend.dto.CartLine;
import net.sim.shoppingbackend.dto.OrderDetail;
import net.sim.shoppingbackend.dto.OrderItem;
import net.sim.shoppingbackend.dto.Product;
import net.sim.shoppingbackend.dto.User;
